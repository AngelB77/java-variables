public class Universe {
    public static void main(String[] args) {
        ...
        //Escribe aquí tu código
        long población = 8_118_302_456L;
        //System.out.println(población);


        //Imprime el resultado final
        System.out.println("La población mundial actual es de " +población+ "habitantes.");


        //La vía láctea parece tener unos cuatrocientos mil millones de estrellas, crea una variable con esa cantidad.

        //Escribe aquí tu código
        long viaLactea = 400_000_000_000L;
        ...
        System.out.println("Hay " +viaLactea + andromeda+ " de estrellas en Andrómeda y en la Vía Láctea juntas.");
